  ...
  return (
    <main className="min-h-screen bg-white">
      <section className="bg-[#0F2540] text-white px-6 py-24 text-center">
        <p className="text-xs uppercase tracking-widest text-[#D4AF37] font-bold mb-4">Sow Into The Kingdom</p>
        <h1 className="font-serif text-5xl mb-6">Give to Pure Faith Global</h1>
