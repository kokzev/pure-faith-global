...
function detectType(file: File): 'image' | 'video' | 'audio' | 'article' {
  ...
  return 'article'; // safe fallback — never defaults to audio/video for unknown files
}
    ...
    <div className="max-w-lg mx-auto p-12 bg-white rounded-3xl shadow-2xl mt-12 border border-gray-100">
      ...
      <form onSubmit={handleUpload} className="space-y-8">
        ...
        <div>
          ...
          />
          <p className="mt-2 text-xs text-gray-400">Type is detected automatically from the file — no manual selection needed.</p>
        </div>
        <button
          type="submit"
...
'@ | Set-Content app\admin\media\page.tsx